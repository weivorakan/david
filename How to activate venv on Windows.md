---
title: "วิธีเปิดใช้งาน Virtual Environment Windows - Google Gemini"
date: "2026-05-12T18:06:05.585Z"
url: "https://gemini.google.com/app/a3c0fc8805bba734"
platform: "gemini"
message_count: 6
---

# วิธีเปิดใช้งาน Virtual Environment Windows - Google Gemini (6 Messages)

🔗 **Original**: [https://gemini.google.com/app/a3c0fc8805bba734](https://gemini.google.com/app/a3c0fc8805bba734)
📅 **Exported at**: 2026-05-12T18:06:05.585Z

> **Statistics**
> - **Messages**: 6 (3 User, 3 Assistant)
> - **Word Count**: ~551 (~3 min read)
> - **Code Blocks**: 3
> - **Tables**: 1
...
1. [User: คุณบอกว่า ทำไมถึงใช้คำสั่ง source venv/bin/activ...](#message-1)
2. [Assistant: สาเหตุที่ใช้คำสั่ง source venv/bin/activate บน C...](#message-2)
3. [User: คุณบอกว่า ทำไม powershell บน VS Code ของผมถึงขึ้...](#message-3)
4. [Assistant: เหตุการณ์นี้มักเกิดจากฟีเจอร์ "Auto Activate Env...](#message-4)
5. [User: คุณบอกว่า ในกรณีที่มีการ activate venv ไว้ ถ้าผม...](#message-5)
6. [Assistant: สำหรับการยกเลิกการใช้งาน Virtual Environment หรื...](#message-6)

<a id="message-1"></a>
## 👤 User
*🕐 2026-05-12T18:06:05.585Z | #1 | Turn 1*
...
<a id="message-3"></a>
## 👤 User
*🕐 2026-05-12T18:06:05.585Z | #3 | Turn 2*
...
<a id="message-5"></a>
## 👤 User
*🕐 2026-05-12T18:06:05.585Z | #5 | Turn 3*
